        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2021, 8, 5, 15, 42, 57, 129, DateTimeKind.Local).AddTicks(3567)),
                    UserId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 8, 5, 15, 42, 57, 149, DateTimeKind.Local).AddTicks(1591), 100000m, 200000m, null });
